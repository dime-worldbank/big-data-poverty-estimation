...
# MAIN PARAMETERS
SURVEY_NAME   <- "DHS"
API_KEY_EMAIL <- "ieconnectlagosproject10@gmail.com" # robmarty3@gmail.com, robertandrewmarty3@gmail.com, robertandrewmarty@gmail.com
...
df <- df[df$country_code %in% c("SN", "KM", "SZ", "GM", "GY", "KY", "LB", "ML", "TG", "GA"),]
